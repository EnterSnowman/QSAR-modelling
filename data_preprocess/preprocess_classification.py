...
def show_list_descriptors(path_to_data):
    datasets = ['train', 'test']
    for d in datasets:
        ...
        for index, row in df['SMILES'].iteritems():
            ...
            if id >= 0:
                # lists
                print(len(rdMolDescriptors.CalcAUTOCORR3D(m3)))
                print(len(rdMolDescriptors.CalcRDF(m3)))
                print(len(rdMolDescriptors.CalcMORSE(m3)))
                print(len(rdMolDescriptors.CalcWHIM(m3)))
                print(len(rdMolDescriptors.CalcGETAWAY(m3)))
